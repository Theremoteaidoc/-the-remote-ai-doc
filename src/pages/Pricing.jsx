...
/**
 * /pricing: physician subscription and fleet quote. Outcome copy only.
 */
export default function Pricing() {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>Pricing: SeaScope clinical services</title>
        <meta
          name="description"
          content="SeaScope CDS for individual physicians: $29.99/month. Fleet telemedicine, PEME processing, and crew wellness: quoted per fleet on a 30-minute call."
        />
      ...
      <section className="bg-gradient-to-br from-ink-900 via-ink-800 to-ink-900 pt-32 pb-16 lg:pt-40">
        <div className="mx-auto max-w-4xl px-6 text-center lg:px-8">
          ...
          <h1 className="font-display text-5xl font-normal leading-tight text-ink-50 sm:text-6xl">
            Clinical services for physicians and for fleets<span className="accent-sea">.</span>
          </h1>
          <p className="mx-auto mt-8 max-w-2xl text-base text-ink-50/70">
            SeaScope CDS is sold direct to physicians as a personal subscription. Fleet
            telemedicine, PEME processing, and crew wellness are quoted per fleet.
          </p>
        </div>
      </section>
      ...
      <section className="pb-24 pt-16 sm:pb-32">
        <div className="mx-auto grid max-w-7xl gap-8 px-6 lg:grid-cols-2 lg:px-8">
          ...
          <div className="editorial-card border-sea-500/40">
            ...
            <h2 className="font-display text-3xl font-medium text-ink-50">Fleet services</h2>
            ...
            <ul className="mt-8 space-y-3 text-sm">
              {[
                'Telemedicine for the ship, with an SOS line to your desk',
                'PEME processing, priced per exam',
                'Crew wellness: self-enrol from a poster',
                'MLC-aligned documentation',
                'Quoted per fleet on a 30-minute call',
              ].map((item) => (
                <li key={item} className="flex items-start gap-3 text-ink-50/85">
                  <Check className="mt-0.5 h-4 w-4 flex-shrink-0 text-sea-500" />
                  {item}
            ...
            <table className="w-full text-sm">
              <thead className="bg-ink-800">
                <tr>
                  ...
                  <th className="px-6 py-4 text-left font-medium text-ink-50">Fleet services</th>
                </tr>
              </thead>
              <tbody className="divide-y divide-ink-700/60">
                {[
                  ...
                  ['Onboarding', 'Instant, log into the app', '1 to 2 weeks per fleet'],
      ...
      <section className="py-24">
        <div className="mx-auto max-w-3xl px-6 lg:px-8">
          ...
          <dl className="mt-12 space-y-6">
            {[
              {
                q: 'Why is fleet pricing not fully public?',
                a: 'Fleet deployments vary by size, vessel type, and which services you take. We share the commercial structure, including volume discounts and evaluation terms, in a 30-minute call.',
              },
              {
              ...
              {
                q: 'Custom enterprise (700+ vessels)?',
                a: 'Yes. Fleets above 700 vessels move into a custom commercial structure. Contact hello@seascope.tech.',
              },
              {
      ...
      <section className="bg-sea-gradient py-20">
        <div className="mx-auto max-w-3xl px-6 text-center lg:px-8">
          <h2 className="font-display text-3xl font-normal text-ink-900 sm:text-4xl">
            Pick the offer that fits who you are.
          </h2>
